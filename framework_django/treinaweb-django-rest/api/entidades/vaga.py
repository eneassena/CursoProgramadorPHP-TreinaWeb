...
class Vaga():
	def __init__(self, titulo, descricao, salario, local,
                quantidade, tipo_contratacao, contato, tecnologias):
	...
	@property
	def contato(self): return self.__contato
	...
	@property
	def tipo_contratacao(self): return self.__tipo_contratacao
